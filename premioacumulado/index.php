...
$data = json_decode($json, true)["El Acumulado Loto"]["Next Draw"]["draws"];

$drawnumber = $data["drawnumber"];
$jackpot = $data["jackpot"];
/*$multix["fecha"] = date("Y-m-d",substr($data["drawdate"],0,10));
$multix["hora"] = date("H:i:s",substr($data["drawdate"],0,10));*/

//var_dump($data["El Acumulado Loto"]);
